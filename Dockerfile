...
RUN --mount=type=cache,id=s/f4ed9832-5af2-4f5a-a0cc-5aa13c84a2e3-/root/.cache/uv,target=/root/.cache/uv \
...
RUN --mount=type=cache,id=s/f4ed9832-5af2-4f5a-a0cc-5aa13c84a2e3-/root/.npm,target=/root/.npm \
    npm ci
